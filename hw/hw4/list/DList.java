...
public class DList {
  ...
  */
  ...
  public DList() {
    ...
    // manipulate head's prev and next to form a sentinel
    head.prev = head;
    head.next = head;
    size = 0;
  }
  ...
  public void insertBefore(Object item, DListNode node) {
    ...
    if (node != null) {
      ...
      //node.prev = newnode; //should be moved 
      // 顺序应该是先看什么的next指向新node，再看什么的prev指向新node
  ...
  // main function code borrow from hliang (https://github.com/hliang)
