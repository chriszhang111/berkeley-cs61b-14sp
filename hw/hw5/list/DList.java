...
public class DList extends List {
  ...
  protected DListNode newNode(Object item, DList list,
    ...
    //return new DListNode(item, this.list, prev, next);
    //??? why cannot I use this.list? 
  ...
  public DList() {
    ...
    //for any sentinel node st, st is invalid node and st.myList = null
  ...
  public void insertFront(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
    //DListNode newnode = newNode(item, this.list, head, head.next);
    //DListNode newnode = newNode(item, list, head, head.next);
  ...
  public void insertBack(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
    //DListNode newnode = newNode(item, this.list, head.prev, head);
    //DListNode newnode = newNode(item, list, head.prev, head);
