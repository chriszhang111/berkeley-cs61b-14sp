...
public class DListNode extends ListNode {
  ...
  // if you check SListNode.java you will find the differecne bt SListNode and DListNode:
  // the difference is that SListNode only has "next",while DListNode has both "next" and "prev"
